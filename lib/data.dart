...
class AppDatabase {
  ...
  static List<PostData> get posts {
    return [
      PostData(
          id: 1,
          title: ' MacBook Pro with M1Pro and M1Max review',
          caption: 'TOP GEAR',
          isBookmarked: false,
          likes: '3.1k',
          time: '1hr ago',
  ...
  static List<OnBoardinItem> get onBoardingItems {
    List<OnBoardinItem> onBoarding = [];
    for (var i = 0; i < 4; i++) {
      onBoarding.add(OnBoardinItem('Read the article you want instantly',
...
class OnBoardinItem {
  ...
  OnBoardinItem(this.title, this.description);
}
